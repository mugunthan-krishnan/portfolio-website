...
import { BsArrowRight, BsFileCodeFill, BsLinkedin } from "react-icons/bs";
        ...
        <section ref={ref} id="home"
            ...
            <div className='flex items-center justify-center'>
                <div className='relative'>
                    ...
                    >
                        <Image src="/mugunthanportrait.jpeg" alt="Mugunthan Portrait"
                        width="192"
                        height="192"
                        quality="95"
                        priority={true}
                    ...
                    <motion.span className='absolute bottom-0 right-0 text-10x10'
                        initial={{ opacity: 0, scale: 0}}
                        animate={{ opacity: 1, scale: 1}}
                        transition={{
                            type: "spring",
            ...
            <motion.h1
                className="mb-10 mt-4 px-4 text-2x1 font-medium !leading-[1.3] sm:text-4xl"
                    initial={{ opacity: 0, y: 100 }}
                    animate={{ opacity: 1, y: 0 }}
            >
                <span className="font-bold">Hello, I'm Mugunthan Krishnan.</span> I'm a{" "}
                <span className="font-bold">Software Engineer</span> with{" "}
                <span className="font-bold">4 years</span> of experience. I enjoy
                <span className="italic"> challenges and design elegant solutions.</span> 
            </motion.h1>
            ...
            <a
                ...
                href="/Mugunthan_Krishnan_Resume.pdf"
                download
            >
                Download Resume{" "}
            ...
            <a
                ...
                href="https://www.linkedin.com/in/mugunthank11"
                target="_blank"
            >
                <BsLinkedin />
            </a>
            ...
            <a
                className="bg-white p-4 text-gray-700 flex items-center gap-2 
                            ...
                            borderBlack dark:bg-white/10 dark:text-white/60"
                href="https://github.com/mugunthan-krishnan"
                target="_blank"
            >
                <FaGithubSquare />
            </a>
            ...
            <a
                className="bg-white p-4 text-gray-700 flex items-center gap-2 
                            ...
                            hover:text-gray-950 active:scale-105 transition cursor-pointer 
                            borderBlack dark:bg-white/10 dark:text-white/60"
                href="https://leetcode.com/mugunthankrishnan/"
                target="_blank"
            >
                <BsFileCodeFill />
            </a>
